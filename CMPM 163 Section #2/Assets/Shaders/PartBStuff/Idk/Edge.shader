Shader "Custom/Edge"
{
    ...
    SubShader
    {
        ...
        float3x3 Gx = float3x3( -1, -2, -1, 
								 0,  0,  0, 
								 1,  2,  1 ); // x direction kernel

        float3x3 Gy = float3x3( -1, 0, 1, 
								-2, 0, 2, 
        ...
        float4 edgePix = float4(float3(1.0,1.0,1.0) - float3( 1-G,1-G,1-G ), 1.0);
